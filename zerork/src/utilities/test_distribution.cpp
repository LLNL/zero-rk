...
bool checkSuccessTest01(zerork::Distribution *dist);
...
bool checkSuccessTest02(zerork::Distribution *dist);

int main(int argc, char *argv[])
{
  zerork::Distribution dist01(num_bins_test01,
                           min_test01,
                           max_test01,
                           true);
  zerork::Distribution *dist01a;
  fill_quadratic(0,num_samples_test01-1,&dist01);
  dist01a = new zerork::Distribution(dist01); // new copy constructor
  zerork::Distribution dist01b(dist01);  // copy constructor
  zerork::Distribution dist01c; // default constructor (unit interval, 1 bin)
  ...
  zerork::Distribution dist02(num_bins_test02,
                           min_test02,
                           max_test02,
                           false);
  zerork::Distribution *dist02a, dist02c;
  fill_linear(-10,250,&dist02);

  dist02a = new zerork::Distribution(dist02); // new copy constructor
  zerork::Distribution dist02b(dist02);  // copy constructor
