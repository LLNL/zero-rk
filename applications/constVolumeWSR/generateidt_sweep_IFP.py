...
spify_parser_params.append(
{
    'name':"idt_method",
    'type':'int',
    'shortDesc' : "Method for choosing IDT if multiple temperature crossings occur.  For first crossing set 0, last crossing 1, and average of all crossings 2",
    'defaultValue' : 0,
    'boundMin': 0,
    'boundMax': 2
}
...
spify_parser_params.append(
{
    'name':"continue_after_ignition",
    'type':'int',
    'shortDesc' : "Continue integration to stop time after ignition delay criteria met",
    'defaultValue' : 1
}
)
