#ifndef SWEEP_UTIL_FORMATTED_H
#define SWEEP_UTIL_FORMATTED_H
...
class idt_sweep_params
{
 public:
  ...
  int dumpJacobian()  const {return 0;}
  int longOutput()        const {return 0;}
 ...
 private:
  ...
  int nFuelSpc,nOxidSpc,nTraceSpc;
  int isConstPres;
