...
int main(int argc, char *argv[])
{
  ...
  scaler      = N_VNew_Parallel(comm, num_local_states, total_states);
  constraints = N_VNew_Parallel(comm, num_local_states, total_states);
  ...
  // TO DO: add sensitivity analysis here
